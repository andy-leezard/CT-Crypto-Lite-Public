...
const Picker_iOS:React.FC<Props> = ({ datainterval, globalContext, callBack }) => {
    ...
    return (
        <>
            <Text style={{color:textColor(globalContext.env.darkmode!),fontWeight:"600",fontSize:16,textAlign:"left"}}>
                {I18n.t('inthepast')}
            </Text>
            <TouchableOpacity style={{backgroundColor:intervalContainerColor(globalContext.env.darkmode!),borderRadius:3,paddingHorizontal:5,marginLeft:5,justifyContent:"center",alignItems:"center"}} onPress={()=>pickerRef.current!.show()}>
