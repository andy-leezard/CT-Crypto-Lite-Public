...
const MyRewards: React.FC<Props> = ({ route, navigation }) => {
  ...
  const openUseReferral = () => {
    if (mainContext.user.referral_code !== "") {
      ...
      Alert.alert(I18n.t("notification"), I18n.t("ref_er1"), [
        { text: I18n.t("ok"), onPress: () => setConfig_ModalVisible(true) },
  ...
  const copyToClipboard = () => {
    ...
    Alert.alert(
      I18n.t("notification"),
      I18n.t("ref_clipboard") + (mainContext.user.referral_code ?? ""),
      [{ text: I18n.t("ok") }]
    )
  }
        ...
        if (duplicate) {
          ...
          const stage1 = () => {
            return new Promise((resolve, reject) => {
              db.collection("referrals")
                .doc(config_code)
                .set({ target: globalContext.state.auth.userEmail })
                .then(resolve)
                .catch(reject)
            })
          }
          const stage2 = () => {
            return new Promise((resolve, reject) => {
              db.collection("users")
                .doc(globalContext.state.auth.userEmail!)
                .update({ referral_code: config_code })
                .then(resolve)
                .catch(reject)
            })
          }
      ...
      try {
        ...
        if (response.status === 200) {
          if (response.data === "ref/success") {
            ...
            Alert.alert(
              I18n.t("notification"),
              I18n.t("reward_code_success") + rewardCode,
              [
                {
                  text: I18n.t("done"),
        ...
        >
          ...
          {!processing && (
            <TextInput
              style={[
                styles.input,
                {
                  backgroundColor: globalContext.state.env.darkmode
                    ? "#333333"
                    : "rgba(0,0,0,0.25)",
                },
              ]}
          ...
          <Pressable
            ...
            style={[
              styles.button,
              {
                backgroundColor: processing ? "#5c5c5c" : "#2196F3",
            ...
            <>
              ...
              <View
                style={{
                  ...
                  height: 200,
                  overflow: "scroll",
                  backgroundColor: containerColor_bis(
    ...
    <>
      <View
        style={{
          alignItems: "center",
          height:
            globalContext.state.env.screenHeight -
            dynamic_bottom_tab_Height(
              Boolean(
                mainContext.user.adblock || mainContext.adEnv.globalAdBlock
              )
            ),
        }}
      >
        <View style={{ flex: 1 }}>
          <ScrollView>
            <View
              style={{
                width: globalContext.state.env.screenWidth - 40,
                height: "auto",
                padding: 5,
                borderRadius: 10,
            ...
            >
              ...
              {mainContext.user.referral_code !== "" && (
                ...
                >
                  {I18n.t("my_refcode")} : {mainContext.user.referral_code}
                </Text>
              )}
              {mainContext.user.referral_code !== "" && (
                <TouchableOpacity
                  style={{
                    width: globalContext.state.env.screenWidth - 60,
                    marginVertical: 10,
                    padding: 5,
                    borderRadius: 10,
                ...
                >
                  <Image
                    ...
                    style={{
                      ...
                      alignSelf: "center",
                      marginBottom: 5,
                      tintColor: bgColor(globalContext.state.env.darkmode!),
                    }}
                  />
                  <Text
                    style={{
              ...
              {mainContext.user.referral_code === "" && (
                <TouchableOpacity
                  ...
                  onPress={() => setConfig_ModalVisible(true)}
                >
                  <Image
                    source={require("../assets/icons/1x/pencil.png")}
                    style={{
            ...
            >
              ...
              >
                - {I18n.t("p_my_rewards._1_4")}{" "}
                {mainContext.user.reward_acc ?? -2} $
              </Text>
              <Text
                style={{
                  color: textColor(globalContext.state.env.darkmode!),
              ...
              >
                - {I18n.t("p_my_rewards._1_5")} {mainContext.user.seed} $
              </Text>
              <Text
                style={{
                  color: textColor(globalContext.state.env.darkmode!),
              ...
              >
                - {I18n.t("p_my_rewards._1_2")} {mainContext.adEnv.rewards._1} $
              </Text>
              <Text
                style={{
                  color: textColor(globalContext.state.env.darkmode!),
              ...
              >
                - {I18n.t("p_my_rewards._1_3")} {mainContext.adEnv.rewards._70}{" "}
                $
              </Text>
